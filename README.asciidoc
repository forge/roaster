...
image:https://github.com/forge/roaster/workflows/GitHub%20CI/badge.svg["Actions Status", link="https://github.com/forge/roaster/actions"]
...
```xml
<properties>
  <version.roaster>2.22.0.Final</version.roaster>
</properties>
