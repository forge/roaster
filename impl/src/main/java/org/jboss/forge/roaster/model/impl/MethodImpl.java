    ...
    implements MethodSource<O>
{
    ...
    {
        return (parent instanceof JavaInterfaceSource) ? true : modifiers.hasModifier(method,
    ...
    public ParameterSource<O> addParameter(String type, String name)
    {
        ...
        String resolvedType =
            imprt != null ? Types.rebuildGenericNameWithArrays(imprt.getSimpleName(), innerType) : Types
                .toSimpleName(type);
